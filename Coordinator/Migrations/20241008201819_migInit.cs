    ...
    public partial class migInit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("244fae4b-35b9-4d17-aaec-80768fb4059b"), "Order.API" },
                    { new Guid("2f771d86-8b52-4962-a774-f14f24509cd1"), "Stock.API" },
                    { new Guid("4b3d3cdb-26af-469d-a436-a28bebe5df09"), "Payment.API" }
                });
